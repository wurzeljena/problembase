...
<body>
	...
	<li <?= ($origin != 0) ? "class='alt'" : ""?>>Haben Sie eine falsche Adresse eingegeben? Dann gehen Sie zur <a href="<?=WEBROOT?>/">Hauptseite</a> und suchen von dort die gewünschte Seite.</li>
