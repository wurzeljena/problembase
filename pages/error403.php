...
<body>
	...
	<p>Sie haben nicht die nötigen Rechte, um die Seite anzusehen bzw. Operation auszuführen. Wenn Sie glauben, dass das ein Fehler ist, wenden Sie sich bitte an den
	<a href="<?php
	...
	<p>Zurück zur <a href="javascript:history.back();">vorhergehenden</a> oder zur <a href="<?=WEBROOT?>/">Hauptseite</a>.</p>
